--------------------------------------------------------------------------------
--- Low-level FFI bindings to hiredis.
-- @module ffi-hiredis.ffi
...
--------------------------------------------------------------------------------
-- Based on BSD-licensed hiredis.h and async.h from hiredis v0.11.0
...
ffi.cdef [[
/* Excerpt from hiredis.h */

/* NOTE: void * converted to concrete types where appropriate */
...
/* Backwards compatibility section intentionally removed from FFI bindings */
